...
public class PhotosGetAllQueryWithExtended extends AbstractQueryBuilder<PhotosGetAllQueryWithExtended, GetAllExtendedResponse> {
     ...
     */
    public PhotosGetAllQueryWithExtended ownerId(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    protected PhotosGetAllQueryWithExtended extended(Boolean value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public PhotosGetAllQueryWithExtended offset(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public PhotosGetAllQueryWithExtended count(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public PhotosGetAllQueryWithExtended photoSizes(Boolean value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public PhotosGetAllQueryWithExtended noServiceAlbums(Boolean value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public PhotosGetAllQueryWithExtended needHidden(Boolean value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public PhotosGetAllQueryWithExtended skipHidden(Boolean value) {
